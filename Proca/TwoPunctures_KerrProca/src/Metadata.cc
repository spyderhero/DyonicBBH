/* TwoPunctures_KerrEinsteinMaxwell: Metadata */
...
extern "C"
void TPKP_TwoPunctures_Metadata (CCTK_ARGUMENTS)
{
...
" << endl;
    ...
    o << "initial-data-type             = Kerr plus direct Einstein-Maxwell electric/magnetic fields in quasi-isotropic coordinates" << endl;
    o << "initial-data-bibtex-keys      = Bowen:1980yu Brandt:1997tf Ansorg:2004ds Liu:2009al Okawa:2014nda Zilhao:2015tya Notes:WitekZilhao" << endl;
