...
subroutine qlm_em_killing_transport (CCTK_ARGUMENTS, hn)
  use cctk
  use constants
  use lapack
  use qlm_em_boundary
  use qlm_em_killing_transportation
  implicit none
  ...
  n=3
  qlm_em_killing_eigenvalue_re(hn) = wr(n)
  qlm_em_killing_eigenvalue_im(hn) = wi(n)
...
9999 continue
end subroutine qlm_em_killing_transport
