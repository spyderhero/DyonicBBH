                    ...
                    CCTK_REAL Ei[3], CCTK_REAL Bi[3], CCTK_REAL *F2)
{
  ...
  Er_plus  = par_electric_charge_plus / (r_plus*r_plus);
  Er_minus = par_electric_charge_minus / (r_minus*r_minus);
  ...
  Br_plus  = par_magnetic_charge_plus / (r_plus*r_plus);
  Br_minus = par_magnetic_charge_minus / (r_minus*r_minus);
		 ...
		 CCTK_REAL y, CCTK_REAL z, derivs U, CCTK_REAL *values)
{
  ...
  psi = sqrt( pow(1 + 0.5 * par_m_plus / r_plus
              ...
              - 0.25 * (pow( par_electric_charge_plus/r_plus + par_electric_charge_minus/r_minus, 2) + pow( par_magnetic_charge_plus/r_plus + par_magnetic_charge_minus/r_minus, 2)) ) + U.d0[0];
  psi_ana = sqrt( pow(1 + 0.5 * par_m_plus / r_plus
              + 0.5 * par_m_minus/ r_minus , 2)
              - 0.25 * (pow( par_electric_charge_plus/r_plus + par_electric_charge_minus/r_minus, 2) + pow( par_magnetic_charge_plus/r_plus + par_magnetic_charge_minus/r_minus, 2)) );
  psi2 = psi * psi;
  psi4 = psi2 * psi2;
  psi7 = psi * psi2 * psi4;
