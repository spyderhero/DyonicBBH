...
void EisnteinMaxwell_RegisterVars(CCTK_ARGUMENTS)
{
   ...
   *
   * This is consistent with EisnteinMaxwell_calc_rhs_EM_direct_corrected.F90:
   *   ProcaBase::Ei              <-> EisnteinMaxwellEvolve::rhs_Ei
   *   ProcaBase::Bi              <-> EisnteinMaxwellEvolve::rhs_Bi
   *   ProcaBase::Psi             <-> EisnteinMaxwellEvolve::rhs_Psi
   *   ProcaBase::Phi             <-> EisnteinMaxwellEvolve::rhs_Phi
   *
